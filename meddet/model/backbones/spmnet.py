...
class SCPMNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv3d(in_channels, 32, kernel_size=3,
        ...
        self.conv_2x = Conv_Block(64, out_channels)
        ...
        self.maxpool_c2 = nn.MaxPool3d(2,2)
        self.maxpool_c4 = nn.MaxPool3d(2,2)
        self.maxpool_c8 = nn.MaxPool3d(2,2)
        self.maxpool_c16 = nn.MaxPool3d(2,2)
    ...
    def forward(self, x, coord_feature):
        c_2 = self.maxpool_c2(coord_feature)
        c_4 = self.maxpool_c2(c_2)
        c_8 = self.maxpool_c2(c_4)
        c_16 = self.maxpool_c2(c_8)
